...
class ConditionalMoveTaskLinkChange extends ConditionalMoveBaseAction
{
    /**
    ...
    {
        return t('When adding or updating task links, move task from a source column to a destination column if all linked tasks of a specific type meet status requirements');
    }
